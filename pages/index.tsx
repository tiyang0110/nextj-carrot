  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10">
      <div className="bg-white p-6 rounded-3xl shadow-2xl">
        ...
        <div className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-500">Checkout</div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-2xl">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sx text-gray-500">Chair</span>
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              <button className="w-5 h-5 rounded-full bg-yellow-500 focus:ring-2 ring-offset-2 ring-yellow-500 transition"/>
              <button className="w-5 h-5 rounded-full bg-purple-500 focus:ring-2 ring-offset-2 ring-purple-500 transition"/>
              <button className="w-5 h-5 rounded-full bg-teal-500 focus:ring-2 ring-offset-2 ring-teal-500 transition"/>
            </div>
            <div className="flex items-center space-x-5">
              <button className="flex rounded-md justify-center items-center bg-blue-200 aspect-square text-xl text-gray-500 w-8">-</button>
              <span>1</span>
              <button className="flex rounded-md justify-center items-center bg-blue-200 aspect-square text-xl text-gray-500 w-8">+</button>
            </div>
          </div>
          <div className="flex justify-between items-center">
            <span className="font-medium font-2xl">$450</span>
